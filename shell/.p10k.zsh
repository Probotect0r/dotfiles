# Generated by Powerlevel10k configuration wizard on 2020-08-12 at 09:49 EDT.
...
# solid, left frame, dark-ornaments, sparse, many icons, concise, transient_prompt,
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local  untracked='%004'   # blue foreground
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND=010
  typeset -g POWERLEVEL9K_STATUS_OK_VISUAL_IDENTIFIER_EXPANSION='✔'

  # Status when some part of a pipe command fails but the overall exit status is zero. It may look
  # like this: 1|0.
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE=true
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND=010
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND=010
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_ASDF_ELIXIR_FOREGROUND=013
  ...
  ##############[ nvm: node.js version from nvm (https://github.com/nvm-sh/nvm) ]###############
  # Nvm color.
  typeset -g POWERLEVEL9K_NVM_FOREGROUND=010
  # Custom icon.
  ...
  ##############################[ node_version: node.js version ]###############################
  # Node version color.
  typeset -g POWERLEVEL9K_NODE_VERSION_FOREGROUND=010
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      ...
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND=013
  ...
  typeset -g POWERLEVEL9K_AWS_EB_ENV_FOREGROUND=010
  # Custom icon.
